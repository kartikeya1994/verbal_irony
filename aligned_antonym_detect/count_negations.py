...
Usage: python count_negations.py data_file negations.txt
"""

import sys
import datetime
from utils import file_iterator, parse_corpus_line, load_negations 
...
if __name__ == '__main__':
    ...
    for line in file_iterator(data_file):
        ...
        words = cols[2].split(' ') + cols[4].split(' ')
        for word in words:       
